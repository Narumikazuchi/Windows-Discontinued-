...
#nullable enable
    ...
    private void SetHexadecimalStringTextBox(Color color)
    {
                                         ...
                                         RoutedPropertyChangedEventArgs<Double> e)
    {
        ...
        if (slider == m_RSlider)
        {
            Color color = Color.FromArgb(this.SelectedColor.A,
                                         (Byte)m_RSlider.Value.Clamp(0.0d, 255.0d),
        ...
        else if (slider == m_GSlider)
        {
            Color color = Color.FromArgb(this.SelectedColor.A,
                                         ...
                                         (Byte)m_GSlider.Value.Clamp(0.0d, 255.0d),
                                         this.SelectedColor.B);
            this.UpdateColorShadeSelectorPosition(color);
            this.SetHexadecimalStringTextBox(color);
            this.SelectedColor = color;
        ...
        else if (slider == m_BSlider)
        {
            Color color = Color.FromArgb(this.SelectedColor.A,
                                         this.SelectedColor.R,
                                         this.SelectedColor.G,
                                         (Byte)m_BSlider.Value.Clamp(0.0d, 255.0d));
            this.UpdateColorShadeSelectorPosition(color);
            this.SetHexadecimalStringTextBox(color);
            this.SelectedColor = color;
        }
        ...
        {
            Color color = Color.FromArgb((Byte)m_ASlider.Value.Clamp(0.0d, 255.0d),
                                         this.SelectedColor.R,
                                         this.SelectedColor.G,
                                         this.SelectedColor.B);
            this.UpdateColorShadeSelectorPosition(color);
