...
namespace Narumikazuchi.Windows
{
    ...
    public static class Utility
    {
        ...
        /// </summary>
        public static Boolean IsOSVistaOrNewer => Environment.OSVersion.Version >= new Version(6, 0);
        /// <summary>
        /// Gets if the current version of windows is Windows 7 or newer.
        /// </summary>
        public static Boolean IsOSWindows7OrNewer => Environment.OSVersion.Version >= new Version(6, 1);
        /// <summary>
        /// Gets if the current version of windows is Windows 8 or newer.
        /// </summary>
        public static Boolean IsOSWindows8OrNewer => Environment.OSVersion.Version >= new Version(6, 2);

        #endregion

        #region Object Release
...
#pragma warning restore
        ...
        private static extern UInt32 FormatMessage(UInt32 dwFlags, IntPtr lpSource, UInt32 dwMessageId, UInt32 dwLanguageId, ref IntPtr lpBuffer, UInt32 nSize, IntPtr pArguments);
        ...
        public static String? GetExitCodeDescription(in Int32 code)
        {
            ...
            UInt32 dwFlags = FormatMessage(FORMAT_MESSAGE_FROM_SYSTEM | FORMAT_MESSAGE_IGNORE_INSERTS | FORMAT_MESSAGE_ALLOCATE_BUFFER, IntPtr.Zero, (UInt32)code, 0, ref lpMsgBuffer, 0, IntPtr.Zero);
            if (dwFlags == 0)
            {
